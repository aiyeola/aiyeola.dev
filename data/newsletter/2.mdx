...
The feeback from the community on launch day and after was massive, I'm most grateful and happy those insights were provided.

So, I'm taking to action the feedback given. Here are a list of the features & ideas I intend to implement
...
The project is open to contributions, if you intend to kindly make a PR to [the repo](https://github.com/aiyeola/aiyeola.dev).
